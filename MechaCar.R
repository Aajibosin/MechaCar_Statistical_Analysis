...
#read file
MechaCar <- read.csv(file='C:/Users/ajibo/OneDrive/Documents/R_Analysis/01_Demo/MechaCarChallenge.RScript/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F)
...
#Deliverable 2------------------------------------------------------------
#read file
Suspension <- read.csv(file='C:Users/ajibo/OneDrive/Documents/R_Analysis/01_Demo/MechaCarChallenge.RScript/Suspension_coil.csv',check.names=F,stringsAsFactors = F)
